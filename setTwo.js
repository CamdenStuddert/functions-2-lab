...
const uniqArr = (uniqArr) => console.log(`The new names array with all the duplicate items removed is ${uniqArr}`)
...
const itemIndex = (item, index) => console.log(`The item at index ${index} is ${item}`)
